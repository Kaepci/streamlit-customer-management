...
# Streamlit UI
st.title("Manajemen Pelanggan dengan Streamlit")

menu = st.sidebar.selectbox("Menu", ["Tambah Pelanggan", "Lihat Pelanggan", "Perbarui Pelanggan", "Hapus Pelanggan", "Kirim Email Promosi"])
...
if menu == "Tambah Pelanggan":
    ...
    if customers:
        ...
        st.write("Belum ada pelanggan yang terdaftar.")
